<template>
    <div>
        <h1><b>Add user to subscribe list</b></h1>
        ...
        <br />
        <button class="test_btn" @click="addToBanList">Add to subscribe list</button>
        <br />
        <span v-html="info1">{{info1}}</span>
        <br />
        <h1><b>Remove from subscribe list</b></h1>
...
<script>
    export default {
        ...
        methods: {
            addToBanList() {
                this.$http.get('https://localhost:44341/api/Subscribe?myName=' + this.myName1 + '&banName=' + this.otherUserName1, {
                    headers: {
            ...
            deleteFromBanList() {
                this.$http.delete('https://localhost:44341/api/Subscribe?myName=' + this.myName2 + '&banName=' + this.otherUserName2, {
                    headers: {
                        'Access-Control-Allow-Origin': '*',
                    },
